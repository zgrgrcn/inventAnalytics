...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.userBooks, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'userid' }),
    __metadata("design:type", user_entity_1.User)
], UserBook.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => book_entity_1.Book, book => book.userBooks, { onDelete: 'CASCADE' }),
